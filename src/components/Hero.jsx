      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mt-8 text-xl sm:text-2xl md:text-3xl font-bold text-[#320b35] flex flex-wrap items-center justify-center gap-2">
            ...
            <span className="inline-block px-4 py-1.5 rounded-2xl bg-[#320b35] text-white border-2 border-[#320b35] shadow-[3px_3px_0px_#320b35] transform rotate-[-1deg] transition-all duration-300 font-extrabold">
              {words[wordIndex]}
            </span>
            <span>?</span>
          </div>
