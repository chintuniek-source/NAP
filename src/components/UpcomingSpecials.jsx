    ...
    <section id="specials" className="py-20 bg-[#F7F2E7] border-y-3 border-[#320b35] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="mt-3 text-lg font-bold text-[#320b35]/80 max-w-xl">
            Live theatre, unscripted storytelling & cultural headline entries.
          </p>
        </div>

        {/* Featured Amol Parashar Entry Card */}
        <div className="bg-white rounded-3xl border-3 border-[#320b35] shadow-[10px_10px_0px_#320b35] overflow-hidden max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 bg-gradient-to-br from-[#7E3940] to-[#552328] p-6 sm:p-8 flex flex-col justify-between relative border-b-3 lg:border-b-0 lg:border-r-3 border-[#320b35] text-white">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-black bg-[#320b35] text-white px-3 py-1 rounded-lg border border-white/40">
                  GUWAHATI • 26th SEPT
                </span>
              </div>
              ...
              <div className="relative my-2 group">
                <div 
                  ...
                  className="rounded-2xl overflow-hidden border-3 border-[#320b35] shadow-[6px_6px_0px_#320b35] cursor-pointer relative bg-black transition-transform duration-200 group-hover:scale-[1.02]"
                >
                  <img 
                ...
                <div className="absolute -bottom-3 -right-2 bg-[#FFEDA8] text-[#320b35] text-xs font-black px-3 py-1 rounded-full border-2 border-[#320b35] shadow-[2px_2px_0px_#320b35] rotate-2">
                  Amol Parashar Live 🎭
                </div>
              </div>
            ...
            <div className="lg:col-span-7 p-8 sm:p-10 flex flex-col justify-between bg-white">
              <div>
                ...
                <div className="mt-5 p-4 rounded-2xl bg-[#F7F2E7] border-2 border-[#320b35] shadow-[3px_3px_0px_#320b35]">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-wider text-gray-500">Written & Directed By</p>
                      <p className="font-black text-[#320b35] text-sm mt-0.5">Vijay Ashok Sharma</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-black text-[#320b35] text-sm mt-0.5">Rooh Storyhouse</p>
                    </div>
                  </div>
                </div>
      ...
      {showPosterModal && (
        ...
        >
          <div 
            ...
            className="bg-white rounded-3xl border-3 border-[#320b35] shadow-[8px_8px_0px_#320b35] max-w-lg w-full p-4 relative overflow-hidden"
          >
            ...
            <div className="mt-3 rounded-xl overflow-hidden border-2 border-[#320b35] max-h-[75vh] overflow-y-auto">
              <img 
                src="/besharam-aadmi.jpg" 
