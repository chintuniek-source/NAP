    ...
    <section id="sleep-over" className="py-24 bg-[#F7F2E7] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <p className="text-sm sm:text-base text-[#320b35]/80 max-w-md font-medium">
          ...
          {activities.map((act) => {
            ...
            return (
              <button
                ...
                className={`p-6 rounded-3xl border-3 border-[#320b35] text-left transition-all duration-200 relative overflow-hidden ${
                  isSelected 
                    ? `${act.accentBg} shadow-[6px_6px_0px_#320b35] translate-x-[-2px] translate-y-[-2px]` 
                    : 'bg-white hover:bg-[#FFEDA8]/30 shadow-[3px_3px_0px_#320b35]'
                }`}
              >
                ...
                <p className="text-xs font-bold text-[#320b35]/80 mt-1">
                  {act.subtitle}
                </p>
              </button>
            );
        ...
        {activities.map((act) => {
          ...
          return (
            <div 
              key={act.id}
              className="bg-white rounded-3xl border-3 border-[#320b35] shadow-[8px_8px_0px_#320b35] p-8 sm:p-12 animate-in fade-in zoom-in-95 duration-200"
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                <div className="lg:col-span-7">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-3xl sm:text-4xl font-black text-[#320b35] font-display">
                        {act.title}
                      </h3>
                    </div>
                  </div>

                  <p className="text-base sm:text-lg text-[#320b35]/80 font-medium leading-relaxed mt-4">
                    {act.summary}
                  </p>
                  ...
                  <div className="mt-6 space-y-3">
                    {act.details.map((detail, idx) => (
                      <div key={idx} className="flex items-start gap-3">
                        <div className="w-5 h-5 rounded-full bg-[#CDD6B7] text-[#320b35] flex items-center justify-center flex-shrink-0 mt-0.5 border border-[#320b35]">
                          <Check className="w-3.5 h-3.5 stroke-[3]" />
                        </div>
                        <span className="text-sm font-bold text-[#320b35]">{detail}</span>
                      </div>
                    ))}
                  </div>
                ...
                <div className="lg:col-span-5 bg-gradient-to-br from-[#FFEDA8]/40 to-[#F7F2E7] p-8 rounded-3xl border-3 border-[#320b35] shadow-[5px_5px_0px_#320b35] text-center flex flex-col justify-between">
                  <div>
                    <div className="w-16 h-16 rounded-2xl bg-white border-2 border-[#320b35] shadow-[3px_3px_0px_#320b35] flex items-center justify-center text-3xl mx-auto mb-4">
                      {act.icon}
                    </div>
                  ...
                  {!isBooked ? (
                    <button
                      ...
                      className="w-full py-4 rounded-xl font-black text-base bg-[#FFEDA8] hover:bg-[#f5e08f] text-[#320b35] border-2 border-[#320b35] shadow-[4px_4px_0px_#320b35] hover:shadow-[2px_2px_0px_#320b35] hover:translate-x-0.5 hover:translate-y-0.5 transition-all flex items-center justify-center gap-2"
                    >
                      <Sparkles className="w-4 h-4" />
                      <span>{act.actionLabel}</span>
                    </button>
                  ) : (
                    <div className="py-4 px-3 rounded-xl bg-[#CDD6B7] border-2 border-[#320b35] text-[#320b35] font-black text-sm flex items-center justify-center gap-2">
                      <ShieldCheck className="w-5 h-5 text-[#320b35]" />
