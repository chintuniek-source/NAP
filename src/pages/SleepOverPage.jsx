...
export default function SleepOverPage({ onOpenJoin }) {
  ...
  return (
    <div className="pt-24 pb-20 bg-[#FFFDF9]">
      
      {/* Hero Banner */}
      <section className="bg-gradient-to-b from-[#FFF4D2] to-[#FFFDF9] py-16 px-4 sm:px-6 lg:px-8 border-b-3 border-[#1E1E24]">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-black text-[#1E1E24] font-display tracking-tight">
            Sleep Over
          </h1>
          
          <p className="mt-4 text-2xl sm:text-3xl font-extrabold text-[#FF8A5B] font-handwriting">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <a href="#nap-o-casting" className="badge-sticker bg-white hover:bg-yellow-100">
              <span>🎙️ Nap-O-Casting</span>
            </a>
            <a href="#breakfast-castle" className="badge-sticker bg-white hover:bg-orange-100">
              <span>🥞 Breakfast Castle</span>
            </a>
            <a href="#pillow-fight" className="badge-sticker bg-white hover:bg-emerald-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 space-y-24">
        ...
        <section id="nap-o-casting" className="scroll-mt-28">
          <div className="bg-[#FFFDF9] rounded-3xl border-3 border-[#1E1E24] shadow-[10px_10px_0px_#1E1E24] overflow-hidden">
            <div className="bg-[#FFD166] p-8 border-b-3 border-[#1E1E24] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-3xl sm:text-5xl font-black text-[#1E1E24] font-display">
                  Nap-O-Casting
                </h2>
                <p className="text-sm font-bold text-[#1E1E24]/80 mt-1">The Chill Couch Audition & Open-Mic</p>
              </div>
            ...
            <div className="p-8 sm:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10">
              <div className="lg:col-span-7">
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-[#FFF9EB] border-2 border-[#1E1E24]">
                    <p className="font-black text-sm text-[#1E1E24]">🛋️ Cozy Lounge Formats</p>
                  ...
                  <div className="p-4 rounded-2xl bg-[#FFF9EB] border-2 border-[#1E1E24]">
                    <p className="font-black text-sm text-[#1E1E24]">📻 Broadcast on Nap Media</p>
                ...
                <div className="mt-8 flex items-center gap-4 text-xs font-bold text-gray-600">
                  <div className="flex items-center gap-1 bg-gray-100 px-3 py-2 rounded-xl border border-black">
              ...
              <div className="lg:col-span-5 bg-[#FFF9EB] p-6 sm:p-8 rounded-2xl border-2 border-[#1E1E24] shadow-[4px_4px_0px_#1E1E24]">
                <h4 className="font-black text-lg text-[#1E1E24] font-display">Grab the Mic Couch</h4>
                ...
                {!pitchSubmitted ? (
                  <form onSubmit={handleCouchPitch} className="mt-4 space-y-3">
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border-2 border-[#1E1E24] text-xs font-bold bg-white"
                    />
                    <select
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2 rounded-xl border-2 border-[#1E1E24] text-xs font-bold bg-white"
                    ></textarea>
                    <button
                      type="submit"
                      className="w-full py-3 rounded-xl font-black text-xs bg-[#FFD166] text-[#1E1E24] border-2 border-[#1E1E24] shadow-[2px_2px_0px_#1E1E24] hover:bg-[#ffe082]"
                    >
                      Submit Couch Reservation
                    </button>
                  </form>
                ) : (
                  <div className="py-6 text-center text-xs font-bold text-emerald-800 space-y-2">
                    <div className="w-10 h-10 rounded-full bg-emerald-200 border border-emerald-500 mx-auto flex items-center justify-center">
                      ✓
                    </div>
        ...
        <section id="breakfast-castle" className="scroll-mt-28">
          <div className="bg-[#FFFDF9] rounded-3xl border-3 border-[#1E1E24] shadow-[10px_10px_0px_#1E1E24] overflow-hidden">
            <div className="bg-[#FF8A5B] text-white p-8 border-b-3 border-[#1E1E24] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
            ...
            <div className="p-8 sm:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-6">
                ...
                <div className="mt-6 space-y-2.5 text-xs font-bold text-gray-800">
                  <div className="flex items-center gap-2">
                    <span className="w-5 h-5 rounded-full bg-[#FF8A5B] text-white flex items-center justify-center text-[10px]">🥞</span>
                ...
                <div className="mt-8 p-4 bg-[#FFF3EC] rounded-2xl border-2 border-[#FF8A5B] flex items-center justify-between">
                  <div>
                    <p className="text-xs font-black text-[#1E1E24]">Weekend Brunch Pass: Free for Nappers</p>
                    <p className="text-[11px] text-gray-600">Every Sunday • 8:30 AM to 1:00 PM</p>
                  </div>
                  <button
                    onClick={onOpenJoin}
                    className="px-4 py-2 rounded-xl bg-[#FF8A5B] text-white font-black text-xs border border-black shadow-[2px_2px_0px_black]"
                  >
                    Claim Seat
                  </button>
                </div>
              ...
              <div className="lg:col-span-6 bg-yellow-50 p-6 sm:p-8 rounded-3xl border-3 border-[#1E1E24] shadow-[4px_4px_0px_#1E1E24] text-center">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-black uppercase text-[#FF8A5B]">Interactive Pancake Lab</span>
                ...
                {/* Pancake Visualizer */}
                <div className="h-44 flex flex-col-reverse items-center justify-start gap-1 p-2 bg-white rounded-2xl border-2 border-black overflow-y-auto mb-4">
                  {pancakeStack.map((layer, index) => (
                    <div
                      key={index}
                      className="px-4 py-1.5 rounded-full bg-gradient-to-r from-amber-200 to-amber-300 border border-black text-[11px] font-black text-[#1E1E24] shadow-sm animate-in zoom-in-95 duration-150"
                ...
                <p className="text-xs font-bold text-gray-700 mb-2">Tap to add delicious toppings to your stack:</p>
                ...
                <div className="flex flex-wrap justify-center gap-1.5 mb-4">
                  {toppings.map((top) => (
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg text-[10px] font-black bg-white hover:bg-amber-100 border border-black shadow-[1px_1px_0px_black] active:translate-y-0.5"
                    >
                      + {top}
                    </button>
                  ))}
                ...
                <button
                  onClick={resetStack}
                  className="text-xs font-bold text-gray-500 hover:text-black flex items-center justify-center gap-1 mx-auto"
                >
        ...
        <section id="pillow-fight" className="scroll-mt-28">
          <div className="bg-[#FFFDF9] rounded-3xl border-3 border-[#1E1E24] shadow-[10px_10px_0px_#1E1E24] overflow-hidden">
            <div className="bg-[#06D6A0] p-8 border-b-3 border-[#1E1E24] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-3xl sm:text-5xl font-black text-[#1E1E24] font-display">
                  Pillow Fight
                </h2>
                <p className="text-sm font-bold text-[#1E1E24]/80 mt-1">Cathartic Joy & The Anti-Stress Championship</p>
              </div>
              <span className="text-5xl">🪶</span>
            </div>
            ...
            <div className="p-8 sm:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10">
              <div className="lg:col-span-7">
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <div className="p-3 rounded-xl bg-[#E8FBF6] border-2 border-[#06D6A0] text-xs font-bold text-gray-800 space-y-2">
                ...
                <div className="mt-8 flex flex-wrap gap-4 text-xs font-bold text-gray-600">
                  <span className="bg-gray-100 px-3 py-1.5 rounded-xl border border-black">
              ...
              {/* Arena RSVP Pass Box */}
              <div className="lg:col-span-5 bg-gradient-to-br from-[#E8FBF6] to-white p-6 sm:p-8 rounded-3xl border-2 border-[#1E1E24] shadow-[4px_4px_0px_#1E1E24] flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs font-black bg-[#06D6A0] px-2.5 py-0.5 rounded border border-black uppercase">
                      Pass Reservation
                    </span>
                    <span className="text-xs font-bold text-red-600 bg-red-100 px-2 py-0.5 rounded border border-red-300">
                      ⚡ Filling Fast
                    </span>
                  </div>
                  ...
                  <div className="my-6 p-4 rounded-2xl bg-white border-2 border-dashed border-gray-400 text-center">
                    ...
                    <p className="text-2xl font-black text-[#06D6A0] font-mono">PILLOW-ARENA-99</p>
                  </div>
                </div>
                ...
                {!bookedArena ? (
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl font-black text-sm bg-[#06D6A0] hover:bg-[#00c28e] text-[#1E1E24] border-2 border-[#1E1E24] shadow-[3px_3px_0px_#1E1E24] flex items-center justify-center gap-2"
                  >
                    <Ticket className="w-4 h-4" />
                    <span>Confirm Arena Entry (Free)</span>
                  </button>
                ) : (
                  <div className="p-3 bg-[#06D6A0] text-[#1E1E24] rounded-xl font-black text-xs text-center border-2 border-black">
