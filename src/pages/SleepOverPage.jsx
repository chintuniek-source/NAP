...
export default function SleepOverPage({ onOpenJoin }) {
  ...
  return (
    <div className="pt-24 pb-20 bg-[#F7F2E7]">
      ...
      {/* Hero Banner */}
      <section className="bg-gradient-to-b from-[#FFEDA8]/50 to-[#F7F2E7] py-16 px-4 sm:px-6 lg:px-8 border-b-3 border-[#320b35]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 space-y-24">
        ...
        <section id="nap-o-casting" className="scroll-mt-28">
          <div className="bg-white rounded-3xl border-3 border-[#320b35] shadow-[10px_10px_0px_#320b35] overflow-hidden">
            <div className="bg-[#FFEDA8] p-8 border-b-3 border-[#320b35] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-3xl sm:text-5xl font-black text-[#320b35] font-display">
                  Nap-O-Casting
                </h2>
                <p className="text-sm font-bold text-[#320b35]/80 mt-1">The Chill Couch Audition & Open-Mic</p>
              </div>
            ...
            <div className="p-8 sm:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10">
              <div className="lg:col-span-7">
                ...
                <p className="mt-3 text-base text-[#320b35]/80 leading-relaxed font-medium">
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-[#F7F2E7] border-2 border-[#320b35]">
                    <p className="font-black text-sm text-[#320b35]">🛋️ Cozy Lounge Formats</p>
                  ...
                  <div className="p-4 rounded-2xl bg-[#F7F2E7] border-2 border-[#320b35]">
                    <p className="font-black text-sm text-[#320b35]">📻 Broadcast on Nap Media</p>
              ...
              <div className="lg:col-span-5 bg-[#FFEDA8]/20 p-6 sm:p-8 rounded-2xl border-2 border-[#320b35] shadow-[4px_4px_0px_#320b35]">
                <h4 className="font-black text-lg text-[#320b35] font-display">Grab the Mic Couch</h4>
                ...
                {!pitchSubmitted ? (
                  <form onSubmit={handleCouchPitch} className="mt-4 space-y-3">
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border-2 border-[#320b35] text-xs font-bold bg-white"
                    />
                    <select
                    ...
                    <button
                      type="submit"
                      className="w-full py-3 rounded-xl font-black text-xs bg-[#FFEDA8] text-[#320b35] border-2 border-[#320b35] shadow-[2px_2px_0px_#320b35] hover:bg-[#ffe380]"
                    >
                      Submit Couch Reservation
                    </button>
                  </form>
                ) : (
                  <div className="py-6 text-center text-xs font-bold text-[#320b35] space-y-2">
                    <div className="w-10 h-10 rounded-full bg-[#CDD6B7] border border-[#320b35] mx-auto flex items-center justify-center font-black">
                      ✓
                    </div>
          ...
          <div className="bg-white rounded-3xl border-3 border-[#320b35] shadow-[10px_10px_0px_#320b35] overflow-hidden">
            ...
            <div className="p-8 sm:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-6">
                ...
                <div className="mt-8 p-4 bg-[#FFEDA8]/40 rounded-2xl border-2 border-[#320b35] flex items-center justify-between">
                  <div>
                    <p className="text-xs font-black text-[#320b35]">Weekend Brunch Pass: Free for Nappers</p>
              ...
              <div className="lg:col-span-6 bg-[#F7F2E7] p-6 sm:p-8 rounded-3xl border-3 border-[#320b35] shadow-[4px_4px_0px_#320b35] text-center">
                ...
                {/* Pancake Visualizer */}
                <div className="h-44 flex flex-col-reverse items-center justify-start gap-1 p-2 bg-white rounded-2xl border-2 border-[#320b35] overflow-y-auto mb-4">
                  {pancakeStack.map((layer, index) => (
                    <div
                      key={index}
                      className="px-4 py-1.5 rounded-full bg-gradient-to-r from-[#FFEDA8] to-[#f4dc79] border border-[#320b35] text-[11px] font-black text-[#320b35] shadow-sm animate-in zoom-in-95 duration-150"
                ...
                <p className="text-xs font-bold text-[#320b35]/80 mb-2">Tap to add delicious toppings to your stack:</p>
                ...
                <div className="flex flex-wrap justify-center gap-1.5 mb-4">
                  {toppings.map((top) => (
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg text-[10px] font-black bg-white hover:bg-[#FFEDA8] border border-[#320b35] shadow-[1px_1px_0px_#320b35] active:translate-y-0.5"
                    >
                      + {top}
                    </button>
                  ))}
                ...
                <button
                  onClick={resetStack}
                  className="text-xs font-bold text-gray-500 hover:text-[#320b35] flex items-center justify-center gap-1 mx-auto"
                >
        ...
        <section id="pillow-fight" className="scroll-mt-28">
          <div className="bg-white rounded-3xl border-3 border-[#320b35] shadow-[10px_10px_0px_#320b35] overflow-hidden">
            <div className="bg-[#CDD6B7] p-8 border-b-3 border-[#320b35] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-3xl sm:text-5xl font-black text-[#320b35] font-display">
                  Pillow Fight
                </h2>
                <p className="text-sm font-bold text-[#320b35]/80 mt-1">Cathartic Joy & The Anti-Stress Championship</p>
              </div>
              <span className="text-5xl">🪶</span>
            </div>
            ...
            <div className="p-8 sm:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10">
              <div className="lg:col-span-7">
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <div className="p-3 rounded-xl bg-[#F7F2E7] border-2 border-[#320b35] text-xs font-bold text-[#320b35] space-y-2">
                ...
                <div className="mt-8 flex flex-wrap gap-4 text-xs font-bold text-gray-600">
                  <span className="bg-[#F7F2E7] px-3 py-1.5 rounded-xl border border-[#320b35]">
              ...
              {/* Arena RSVP Pass Box */}
              <div className="lg:col-span-5 bg-gradient-to-br from-[#CDD6B7]/30 to-white p-6 sm:p-8 rounded-3xl border-2 border-[#320b35] shadow-[4px_4px_0px_#320b35] flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-4">
                  ...
                  <h4 className="text-xl font-black text-[#320b35] font-display">
                ...
                {!bookedArena ? (
                  <button
                    ...
                    className="w-full py-3.5 rounded-xl font-black text-sm bg-[#CDD6B7] hover:bg-[#bcc7a1] text-[#320b35] border-2 border-[#320b35] shadow-[3px_3px_0px_#320b35] flex items-center justify-center gap-2"
                  >
                    <Ticket className="w-4 h-4" />
                    <span>Confirm Arena Entry (Free)</span>
                  </button>
                ) : (
                  <div className="p-3 bg-[#CDD6B7] text-[#320b35] rounded-xl font-black text-xs text-center border-2 border-[#320b35]">
