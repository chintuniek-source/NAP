...
export default function MediaWingPage({ onOpenJoin }) {
  ...
  return (
    <div className="pt-24 pb-20 bg-[#F7F2E7]">
      ...
      {/* Banner */}
      <section className="bg-gradient-to-b from-[#CDD6B7]/30 to-[#F7F2E7] py-16 px-4 sm:px-6 lg:px-8 border-b-3 border-[#320b35]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 space-y-20">
        ...
        {/* AN AALAP FLAGSHIP PLAYER MODULE */}
        <section className="bg-white rounded-3xl border-3 border-[#320b35] shadow-[10px_10px_0px_#320b35] overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            {/* Player Console */}
            <div className="lg:col-span-7 p-6 sm:p-8 flex flex-col justify-between border-b-3 lg:border-b-0 lg:border-r-3 border-[#320b35] bg-white">
              <div>
                {/* Embedded Responsive YouTube Player / Clean Thumbnail */}
                <div className="relative aspect-video rounded-2xl overflow-hidden border-3 border-[#320b35] shadow-[5px_5px_0px_#320b35] bg-black mb-6">
                  {isPlaying ? (
                    <iframe
                ...
                <div className="flex items-center justify-between gap-2 mb-3">
                  ...
                  <span className="text-xs font-black px-2.5 py-0.5 rounded-full bg-[#004958] text-white border border-[#320b35] shadow-[2px_2px_0px_#320b35]">
                    {current.badge}
                  </span>
                </div>

                <h3 className="text-2xl sm:text-3xl font-black text-[#320b35] font-display leading-tight">
                  {current.title}
                </h3>
                ...
                <p className="mt-4 text-sm sm:text-base text-[#320b35]/80 leading-relaxed font-medium">
                  {current.description}
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 p-6 sm:p-8 bg-[#F7F2E7] flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  <h4 className="font-black text-xl text-[#320b35] font-display flex items-center gap-2">
                    <Headphones className="w-5 h-5 text-[#004958]" />
                    <span>An Aalap Episodes Archive</span>
                  </h4>
                  <span className="text-xs font-black bg-[#FFEDA8] text-[#320b35] px-2.5 py-0.5 rounded-full border border-[#320b35] shadow-[2px_2px_0px_#320b35]">
                  ...
                  {episodes.map((ep, i) => {
                    ...
                    return (
                      <div
                        ...
                        className={`p-3 rounded-2xl border-2 border-[#320b35] cursor-pointer transition-all ${
                          isSelected 
                            ? 'bg-white shadow-[4px_4px_0px_#320b35] translate-x-1 border-[#004958]' 
                            : 'bg-white/80 hover:bg-white shadow-[2px_2px_0px_#320b35]'
                        }`}
                      >
                        <div className="flex items-center gap-3">
                          <div className="relative w-18 h-12 rounded-xl overflow-hidden border border-[#320b35] flex-shrink-0 bg-black">
                            <img
                              src={ep.thumbnail}
                              alt={ep.title}
        ...
        <section className="bg-gradient-to-r from-[#004958] to-[#00343F] p-8 sm:p-12 rounded-3xl border-3 border-[#320b35] shadow-[8px_8px_0px_#320b35] text-white">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <span className="bg-white text-[#320b35] font-black text-xs px-3.5 py-1 rounded-full uppercase border border-[#320b35] shadow-[2px_2px_0px_#320b35]">
                Creator Open Call
              </span>
            ...
            <div className="bg-white/10 backdrop-blur-md p-6 sm:p-8 rounded-2xl border border-white/30">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-[#F7F2E7] p-5 rounded-2xl border-2 border-[#320b35] shadow-[4px_4px_0px_#320b35] text-[#320b35] flex flex-col justify-between">
                  <div>
                    <div className="w-10 h-10 rounded-xl bg-[#FFEDA8] text-[#320b35] border-2 border-[#320b35] flex items-center justify-center mb-3">
